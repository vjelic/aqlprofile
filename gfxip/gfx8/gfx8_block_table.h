 ...
 */
// Counter block CB
static const GpuBlockInfo ViCbCounterBlockInfo = {"VI_CB", kHsaViCounterBlockIdCb, VI_NUM_CB, CntlMethodBySeAndInstance, 395, VI_COUNTER_NUM_PER_CB, 0, 0, true, ViCbCounterRegAddr, true, gfx8_cntx_prim::select_value<regCB_PERFCOUNTER0_SELECT__CI__VI>, false};
// Counter block CPF
static const GpuBlockInfo ViCpfCounterBlockInfo = {"VI_CPF", kHsaViCounterBlockIdCpf, 1, CntlMethodNone, 19, VI_COUNTER_NUM_PER_CPF, 0, 0, true, ViCpfCounterRegAddr, false, gfx8_cntx_prim::select_value<regCPF_PERFCOUNTER0_SELECT__CI__VI>, false};
// Counter block DB
static const GpuBlockInfo ViDbCounterBlockInfo = {"VI_DB", kHsaViCounterBlockIdDb, VI_NUM_DB, CntlMethodBySeAndInstance, 256, VI_COUNTER_NUM_PER_DB, 0, 0, true, ViDbCounterRegAddr, true, gfx8_cntx_prim::select_value<regDB_PERFCOUNTER0_SELECT>, false};
// Counter block GRBM
static const GpuBlockInfo ViGrbmCounterBlockInfo = {"VI_GRBM", kHsaViCounterBlockIdGrbm, 1, CntlMethodNone, 33, VI_COUNTER_NUM_PER_GRBM, 0, 0, true, ViGrbmCounterRegAddr, false, gfx8_cntx_prim::select_value<regGRBM_PERFCOUNTER0_SELECT>, false};
// Counter block GRBMSE
static const GpuBlockInfo ViGrbmSeCounterBlockInfo = {"VI_GRBMSE", kHsaViCounterBlockIdGrbmSe, 1, CntlMethodNone, 14, VI_COUNTER_NUM_PER_GRBMSE, 0, 0, true, ViGrbmSeCounterRegAddr, false, gfx8_cntx_prim::select_value<regGRBM_SE0_PERFCOUNTER_SELECT>, false};
// Counter block PA_SU
static const GpuBlockInfo ViPaSuCounterBlockInfo = {"VI_PA_SU", kHsaViCounterBlockIdPaSu, 1, CntlMethodBySe, 152, VI_COUNTER_NUM_PER_PA_SU, 0, 0, true, ViPaSuCounterRegAddr, false, gfx8_cntx_prim::select_value<regPA_SU_PERFCOUNTER0_SELECT>, false};
// Counter block PA_SC
static const GpuBlockInfo ViPaScCounterBlockInfo = {"VI_PA_SC", kHsaViCounterBlockIdPaSc, 1, CntlMethodBySe, 396, VI_COUNTER_NUM_PER_PA_SC, 0, 0, true, ViPaScCounterRegAddr, false, gfx8_cntx_prim::select_value<regPA_SC_PERFCOUNTER0_SELECT>, false};
// Counter block SPI
static const GpuBlockInfo ViSpiCounterBlockInfo = {"VI_SPI", kHsaViCounterBlockIdSpi, 1, CntlMethodBySe, 196, VI_COUNTER_NUM_PER_SPI, 0, 0, true, ViSpiCounterRegAddr, false, gfx8_cntx_prim::select_value<regSPI_PERFCOUNTER0_SELECT>, false};
// Counter block SQ
static const GpuBlockInfo ViSqCounterBlockInfo = {"VI_SQ", kHsaViCounterBlockIdSq, 1, CntlMethodBySe, 298, VI_COUNTER_NUM_PER_SQ, 0, 0, true, ViSqCounterRegAddr, false, gfx8_cntx_prim::select_value<regSQ_PERFCOUNTER0_SELECT__CI__VI>, true};
static const GpuBlockInfo ViSqEsCounterBlockInfo = {"VI_SQ_ES", kHsaViCounterBlockIdSqEs, 1, CntlMethodBySe, 298, VI_COUNTER_NUM_PER_SQ, 0, 0, true, ViSqCounterRegAddr, false, gfx8_cntx_prim::select_value<regSQ_PERFCOUNTER0_SELECT__CI__VI>, true};
static const GpuBlockInfo ViSqGsCounterBlockInfo = {"VI_SQ_GS", kHsaViCounterBlockIdSqGs, 1, CntlMethodBySe, 298, VI_COUNTER_NUM_PER_SQ, 0, 0, true, ViSqCounterRegAddr, false, gfx8_cntx_prim::select_value<regSQ_PERFCOUNTER0_SELECT__CI__VI>, true};
static const GpuBlockInfo ViSqVsCounterBlockInfo = {"VI_SQ_VS", kHsaViCounterBlockIdSqVs, 1, CntlMethodBySe, 298, VI_COUNTER_NUM_PER_SQ, 0, 0, true, ViSqCounterRegAddr, false, gfx8_cntx_prim::select_value<regSQ_PERFCOUNTER0_SELECT__CI__VI>, true};
static const GpuBlockInfo ViSqPsCounterBlockInfo = {"VI_SQ_PS", kHsaViCounterBlockIdSqPs, 1, CntlMethodBySe, 298, VI_COUNTER_NUM_PER_SQ, 0, 0, true, ViSqCounterRegAddr, false, gfx8_cntx_prim::select_value<regSQ_PERFCOUNTER0_SELECT__CI__VI>, true};
static const GpuBlockInfo ViSqLsCounterBlockInfo = {"VI_SQ_LS", kHsaViCounterBlockIdSqLs, 1, CntlMethodBySe, 298, VI_COUNTER_NUM_PER_SQ, 0, 0, true, ViSqCounterRegAddr, false, gfx8_cntx_prim::select_value<regSQ_PERFCOUNTER0_SELECT__CI__VI>, true};
static const GpuBlockInfo ViSqHsCounterBlockInfo = {"VI_SQ_HS", kHsaViCounterBlockIdSqHs, 1, CntlMethodBySe, 298, VI_COUNTER_NUM_PER_SQ, 0, 0, true, ViSqCounterRegAddr, false, gfx8_cntx_prim::select_value<regSQ_PERFCOUNTER0_SELECT__CI__VI>, true};
static const GpuBlockInfo ViSqCsCounterBlockInfo = {"VI_SQ_CS", kHsaViCounterBlockIdSqCs, 1, CntlMethodBySe, 298, VI_COUNTER_NUM_PER_SQ, 0, 0, true, ViSqCounterRegAddr, false, gfx8_cntx_prim::select_value<regSQ_PERFCOUNTER0_SELECT__CI__VI>, true};
// Counter block SX
static const GpuBlockInfo ViSxCounterBlockInfo = {"VI_SX", kHsaViCounterBlockIdSx, 1, CntlMethodBySe, 33, VI_COUNTER_NUM_PER_SX, 0, 0, true, ViSxCounterRegAddr, true, gfx8_cntx_prim::select_value<regSX_PERFCOUNTER0_SELECT>, false};
// Counter block TA
static const GpuBlockInfo ViTaCounterBlockInfo = {"VI_TA", kHsaViCounterBlockIdTa, VI_NUM_TA, CntlMethodBySeAndInstance, 118, VI_COUNTER_NUM_PER_TA, 0, 0, true, ViTaCounterRegAddr, false, gfx8_cntx_prim::select_value<regTA_PERFCOUNTER0_SELECT>, false};
// Counter block TCA
static const GpuBlockInfo ViTcaCounterBlockInfo = {"VI_TCA", kHsaViCounterBlockIdTca, VI_NUM_TCA, CntlMethodByInstance, 34, VI_COUNTER_NUM_PER_TCA, 0, 0, true, ViTcaCounterRegAddr, false, gfx8_cntx_prim::select_value<regTCA_PERFCOUNTER0_SELECT__CI__VI>, false};
// Counter block TCC
static const GpuBlockInfo ViTccCounterBlockInfo = {"VI_TCC", kHsaViCounterBlockIdTcc, VI_NUM_TCC, CntlMethodByInstance, 191, VI_COUNTER_NUM_PER_TCC, 0, 0, true, ViTccCounterRegAddr, false, gfx8_cntx_prim::select_value<regTCC_PERFCOUNTER0_SELECT__CI__VI>, false};
// Counter block TD
static const GpuBlockInfo ViTdCounterBlockInfo = {"VI_TD", kHsaViCounterBlockIdTd, VI_NUM_TD, CntlMethodBySeAndInstance, 54, VI_COUNTER_NUM_PER_TD, 0, 0, true, ViTdCounterRegAddr, false, gfx8_cntx_prim::select_value<regTD_PERFCOUNTER0_SELECT>, false};
// Counter block TCP
static const GpuBlockInfo ViTcpCounterBlockInfo = {"VI_TCP", kHsaViCounterBlockIdTcp, VI_NUM_TCP, CntlMethodBySeAndInstance, 182, VI_COUNTER_NUM_PER_TCP, 0, 0, true, ViTcpCounterRegAddr, false, gfx8_cntx_prim::select_value<regTCP_PERFCOUNTER0_SELECT__CI__VI>, false};
// Counter block GDS
static const GpuBlockInfo ViGdsCounterBlockInfo = {"VI_GDS", kHsaViCounterBlockIdGds, 1, CntlMethodNone, 120, VI_COUNTER_NUM_PER_GDS, 0, 0, true, ViGdsCounterRegAddr, false, gfx8_cntx_prim::select_value<regGDS_PERFCOUNTER0_SELECT>, false};
// Counter block VGT
static const GpuBlockInfo ViVgtCounterBlockInfo = {"VI_VGT", kHsaViCounterBlockIdVgt, 1, CntlMethodBySe, 145, VI_COUNTER_NUM_PER_VGT, 0, 0, true, ViVgtCounterRegAddr, false, gfx8_cntx_prim::select_value<regVGT_PERFCOUNTER0_SELECT__CI__VI>, false};
// Counter block IA
static const GpuBlockInfo ViIaCounterBlockInfo = {"VI_IA", kHsaViCounterBlockIdIa, 1, CntlMethodBySe, 23, VI_COUNTER_NUM_PER_IA, 0, 0, true, ViIaCounterRegAddr, false, gfx8_cntx_prim::select_value<regIA_PERFCOUNTER0_SELECT__CI__VI>, false};
// Counter block MC
static const GpuBlockInfo ViMcCounterBlockInfo = {"VI_MC", kHsaViCounterBlockIdMc, 1, CntlMethodNone, 22, VI_COUNTER_NUM_PER_MC, 0, 0, true, ViMcCounterRegAddr, false, NULL, false};
// Counter block SRBM
static const GpuBlockInfo ViSrbmCounterBlockInfo = {"VI_SRBM", kHsaViCounterBlockIdSrbm, 1, CntlMethodNone, 19, VI_COUNTER_NUM_PER_SRBM, 0, 0, true, ViSrbmCounterRegAddr, false, gfx8_cntx_prim::select_value<regSRBM_PERFCOUNTER0_SELECT>, false};
// Counter block WD
static const GpuBlockInfo ViWdCounterBlockInfo = {"VI_WD", kHsaViCounterBlockIdWd, 1, CntlMethodNone, 36, VI_COUNTER_NUM_PER_WD, 0, 0, true, ViWdCounterRegAddr, false, gfx8_cntx_prim::select_value<regWD_PERFCOUNTER0_SELECT__CI__VI>, false};
// Counter block CPG
static const GpuBlockInfo ViCpgCounterBlockInfo = {"VI_CPG", kHsaViCounterBlockIdCpg, 1, CntlMethodNone, 48, VI_COUNTER_NUM_PER_CPG, 0, 0, true, ViCpgCounterRegAddr, false, gfx8_cntx_prim::select_value<regCPG_PERFCOUNTER0_SELECT__CI__VI>, false};
// Counter block CPC
static const GpuBlockInfo ViCpcCounterBlockInfo = {"VI_CPC", kHsaViCounterBlockIdCpc, 1, CntlMethodNone, 24, VI_COUNTER_NUM_PER_CPC, 0, 0, true, ViCpcCounterRegAddr, false, gfx8_cntx_prim::select_value<regCPC_PERFCOUNTER0_SELECT__CI__VI>, false};
// Counter block IOMMUV2
static const GpuBlockInfo ViCounterBlockIommuV2Info = {"VI_IOMMUV2", kHsaViCounterBlockIdIommuV2, 1, CntlMethodNone, 25, 8, 0, 0, true, NULL, false, NULL, false};
// Counter block KernelDriver
static const GpuBlockInfo ViKernelDriverCounterBlockInfo = {"VI_KD", kHsaViCounterBlockIdKernelDriver, 1, CntlMethodNone, 0, 0, 0, 0, true, NULL, false, NULL, false};
