#if !defined(_greenland_ENUM_HEADER)
#define _greenland_ENUM_HEADER
/*
*	gfx9_enum.h
*
...
/*******************************************************
 * WD_DEBUGBUS DATA_TYPE Enums
 *******************************************************/

/*******************************************************
 * IA_DEBUGBUS DATA_TYPE Enums
 *******************************************************/

/*******************************************************
 * VGT_DEBUGBUS DATA_TYPE Enums
 *******************************************************/
...
/*******************************************************
 * ATCL2 DATA_TYPE Enums
 *******************************************************/

/*******************************************************
 * ATCL2PFCNTR DATA_TYPE Enums
 *******************************************************/

/*******************************************************
 * ATCL2PFCNTL DATA_TYPE Enums
 *******************************************************/

/*******************************************************
 * VML2PF DATA_TYPE Enums
 *******************************************************/

/*******************************************************
 * VML2VC DATA_TYPE Enums
 *******************************************************/

/*******************************************************
 * VML2PL DATA_TYPE Enums
 *******************************************************/

/*******************************************************
 * VML2PR DATA_TYPE Enums
 *******************************************************/

/*******************************************************
 * VMSHAREDHV DATA_TYPE Enums
 *******************************************************/

/*******************************************************
 * VMSHAREDPF DATA_TYPE Enums
 *******************************************************/

/*******************************************************
 * VMSHAREDVC DATA_TYPE Enums
 *******************************************************/
...
typedef enum IMG_DATA_FORMAT {
  ...
  IMG_DATA_FORMAT_S8_16 = 0x0000003b,
  IMG_DATA_FORMAT_S8_32 = 0x0000003c,
...
typedef enum IH_PERF_SEL {
  ...
  IH_PERF_SEL_RB1_FULL_VF0 = 0x000000b6,
  IH_PERF_SEL_RB1_FULL_VF1 = 0x000000b7,
  IH_PERF_SEL_RB1_FULL_VF2 = 0x000000b8,
  IH_PERF_SEL_RB1_FULL_VF3 = 0x000000b9,
  IH_PERF_SEL_RB1_FULL_VF4 = 0x000000ba,
  IH_PERF_SEL_RB1_FULL_VF5 = 0x000000bb,
  IH_PERF_SEL_RB1_FULL_VF6 = 0x000000bc,
  IH_PERF_SEL_RB1_FULL_VF7 = 0x000000bd,
  IH_PERF_SEL_RB1_FULL_VF8 = 0x000000be,
  IH_PERF_SEL_RB1_FULL_VF9 = 0x000000bf,
  IH_PERF_SEL_RB1_FULL_VF10 = 0x000000c0,
  IH_PERF_SEL_RB1_FULL_VF11 = 0x000000c1,
  IH_PERF_SEL_RB1_FULL_VF12 = 0x000000c2,
  IH_PERF_SEL_RB1_FULL_VF13 = 0x000000c3,
  IH_PERF_SEL_RB1_FULL_VF14 = 0x000000c4,
  IH_PERF_SEL_RB1_FULL_VF15 = 0x000000c5,
  IH_PERF_SEL_RB1_OVERFLOW_VF0 = 0x000000c6,
  IH_PERF_SEL_RB1_OVERFLOW_VF1 = 0x000000c7,
  IH_PERF_SEL_RB1_OVERFLOW_VF2 = 0x000000c8,
  IH_PERF_SEL_RB1_OVERFLOW_VF3 = 0x000000c9,
  IH_PERF_SEL_RB1_OVERFLOW_VF4 = 0x000000ca,
  IH_PERF_SEL_RB1_OVERFLOW_VF5 = 0x000000cb,
  IH_PERF_SEL_RB1_OVERFLOW_VF6 = 0x000000cc,
  IH_PERF_SEL_RB1_OVERFLOW_VF7 = 0x000000cd,
  IH_PERF_SEL_RB1_OVERFLOW_VF8 = 0x000000ce,
  IH_PERF_SEL_RB1_OVERFLOW_VF9 = 0x000000cf,
  IH_PERF_SEL_RB1_OVERFLOW_VF10 = 0x000000d0,
  IH_PERF_SEL_RB1_OVERFLOW_VF11 = 0x000000d1,
  IH_PERF_SEL_RB1_OVERFLOW_VF12 = 0x000000d2,
  IH_PERF_SEL_RB1_OVERFLOW_VF13 = 0x000000d3,
  IH_PERF_SEL_RB1_OVERFLOW_VF14 = 0x000000d4,
  IH_PERF_SEL_RB1_OVERFLOW_VF15 = 0x000000d5,
  IH_PERF_SEL_RB1_WPTR_WRAP_VF0 = 0x000000d6,
  IH_PERF_SEL_RB1_WPTR_WRAP_VF1 = 0x000000d7,
  IH_PERF_SEL_RB1_WPTR_WRAP_VF2 = 0x000000d8,
  IH_PERF_SEL_RB1_WPTR_WRAP_VF3 = 0x000000d9,
  IH_PERF_SEL_RB1_WPTR_WRAP_VF4 = 0x000000da,
  IH_PERF_SEL_RB1_WPTR_WRAP_VF5 = 0x000000db,
  IH_PERF_SEL_RB1_WPTR_WRAP_VF6 = 0x000000dc,
  IH_PERF_SEL_RB1_WPTR_WRAP_VF7 = 0x000000dd,
  IH_PERF_SEL_RB1_WPTR_WRAP_VF8 = 0x000000de,
  IH_PERF_SEL_RB1_WPTR_WRAP_VF9 = 0x000000df,
  IH_PERF_SEL_RB1_WPTR_WRAP_VF10 = 0x000000e0,
  IH_PERF_SEL_RB1_WPTR_WRAP_VF11 = 0x000000e1,
  IH_PERF_SEL_RB1_WPTR_WRAP_VF12 = 0x000000e2,
  IH_PERF_SEL_RB1_WPTR_WRAP_VF13 = 0x000000e3,
  IH_PERF_SEL_RB1_WPTR_WRAP_VF14 = 0x000000e4,
  IH_PERF_SEL_RB1_WPTR_WRAP_VF15 = 0x000000e5,
  IH_PERF_SEL_RB1_RPTR_WRAP_VF0 = 0x000000e6,
  IH_PERF_SEL_RB1_RPTR_WRAP_VF1 = 0x000000e7,
  IH_PERF_SEL_RB1_RPTR_WRAP_VF2 = 0x000000e8,
  IH_PERF_SEL_RB1_RPTR_WRAP_VF3 = 0x000000e9,
  IH_PERF_SEL_RB1_RPTR_WRAP_VF4 = 0x000000ea,
  IH_PERF_SEL_RB1_RPTR_WRAP_VF5 = 0x000000eb,
  IH_PERF_SEL_RB1_RPTR_WRAP_VF6 = 0x000000ec,
  IH_PERF_SEL_RB1_RPTR_WRAP_VF7 = 0x000000ed,
  IH_PERF_SEL_RB1_RPTR_WRAP_VF8 = 0x000000ee,
  IH_PERF_SEL_RB1_RPTR_WRAP_VF9 = 0x000000ef,
  IH_PERF_SEL_RB1_RPTR_WRAP_VF10 = 0x000000f0,
  IH_PERF_SEL_RB1_RPTR_WRAP_VF11 = 0x000000f1,
  IH_PERF_SEL_RB1_RPTR_WRAP_VF12 = 0x000000f2,
  IH_PERF_SEL_RB1_RPTR_WRAP_VF13 = 0x000000f3,
  IH_PERF_SEL_RB1_RPTR_WRAP_VF14 = 0x000000f4,
  IH_PERF_SEL_RB1_RPTR_WRAP_VF15 = 0x000000f5,
  IH_PERF_SEL_RB2_FULL_VF0 = 0x000000f6,
  IH_PERF_SEL_RB2_FULL_VF1 = 0x000000f7,
  IH_PERF_SEL_RB2_FULL_VF2 = 0x000000f8,
  IH_PERF_SEL_RB2_FULL_VF3 = 0x000000f9,
  IH_PERF_SEL_RB2_FULL_VF4 = 0x000000fa,
  IH_PERF_SEL_RB2_FULL_VF5 = 0x000000fb,
  IH_PERF_SEL_RB2_FULL_VF6 = 0x000000fc,
  IH_PERF_SEL_RB2_FULL_VF7 = 0x000000fd,
  IH_PERF_SEL_RB2_FULL_VF8 = 0x000000fe,
  IH_PERF_SEL_RB2_FULL_VF9 = 0x000000ff,
  IH_PERF_SEL_RB2_FULL_VF10 = 0x00000100,
  IH_PERF_SEL_RB2_FULL_VF11 = 0x00000101,
  IH_PERF_SEL_RB2_FULL_VF12 = 0x00000102,
  IH_PERF_SEL_RB2_FULL_VF13 = 0x00000103,
  IH_PERF_SEL_RB2_FULL_VF14 = 0x00000104,
  IH_PERF_SEL_RB2_FULL_VF15 = 0x00000105,
  IH_PERF_SEL_RB2_OVERFLOW_VF0 = 0x00000106,
  IH_PERF_SEL_RB2_OVERFLOW_VF1 = 0x00000107,
  IH_PERF_SEL_RB2_OVERFLOW_VF2 = 0x00000108,
  IH_PERF_SEL_RB2_OVERFLOW_VF3 = 0x00000109,
  IH_PERF_SEL_RB2_OVERFLOW_VF4 = 0x0000010a,
  IH_PERF_SEL_RB2_OVERFLOW_VF5 = 0x0000010b,
  IH_PERF_SEL_RB2_OVERFLOW_VF6 = 0x0000010c,
  IH_PERF_SEL_RB2_OVERFLOW_VF7 = 0x0000010d,
  IH_PERF_SEL_RB2_OVERFLOW_VF8 = 0x0000010e,
  IH_PERF_SEL_RB2_OVERFLOW_VF9 = 0x0000010f,
  IH_PERF_SEL_RB2_OVERFLOW_VF10 = 0x00000110,
  IH_PERF_SEL_RB2_OVERFLOW_VF11 = 0x00000111,
  IH_PERF_SEL_RB2_OVERFLOW_VF12 = 0x00000112,
  IH_PERF_SEL_RB2_OVERFLOW_VF13 = 0x00000113,
  IH_PERF_SEL_RB2_OVERFLOW_VF14 = 0x00000114,
  IH_PERF_SEL_RB2_OVERFLOW_VF15 = 0x00000115,
  IH_PERF_SEL_RB2_WPTR_WRAP_VF0 = 0x00000116,
  IH_PERF_SEL_RB2_WPTR_WRAP_VF1 = 0x00000117,
  IH_PERF_SEL_RB2_WPTR_WRAP_VF2 = 0x00000118,
  IH_PERF_SEL_RB2_WPTR_WRAP_VF3 = 0x00000119,
  IH_PERF_SEL_RB2_WPTR_WRAP_VF4 = 0x0000011a,
  IH_PERF_SEL_RB2_WPTR_WRAP_VF5 = 0x0000011b,
  IH_PERF_SEL_RB2_WPTR_WRAP_VF6 = 0x0000011c,
  IH_PERF_SEL_RB2_WPTR_WRAP_VF7 = 0x0000011d,
  IH_PERF_SEL_RB2_WPTR_WRAP_VF8 = 0x0000011e,
  IH_PERF_SEL_RB2_WPTR_WRAP_VF9 = 0x0000011f,
  IH_PERF_SEL_RB2_WPTR_WRAP_VF10 = 0x00000120,
  IH_PERF_SEL_RB2_WPTR_WRAP_VF11 = 0x00000121,
  IH_PERF_SEL_RB2_WPTR_WRAP_VF12 = 0x00000122,
  IH_PERF_SEL_RB2_WPTR_WRAP_VF13 = 0x00000123,
  IH_PERF_SEL_RB2_WPTR_WRAP_VF14 = 0x00000124,
  IH_PERF_SEL_RB2_WPTR_WRAP_VF15 = 0x00000125,
  IH_PERF_SEL_RB2_RPTR_WRAP_VF0 = 0x00000126,
  IH_PERF_SEL_RB2_RPTR_WRAP_VF1 = 0x00000127,
  IH_PERF_SEL_RB2_RPTR_WRAP_VF2 = 0x00000128,
  IH_PERF_SEL_RB2_RPTR_WRAP_VF3 = 0x00000129,
  IH_PERF_SEL_RB2_RPTR_WRAP_VF4 = 0x0000012a,
  IH_PERF_SEL_RB2_RPTR_WRAP_VF5 = 0x0000012b,
  IH_PERF_SEL_RB2_RPTR_WRAP_VF6 = 0x0000012c,
  IH_PERF_SEL_RB2_RPTR_WRAP_VF7 = 0x0000012d,
  IH_PERF_SEL_RB2_RPTR_WRAP_VF8 = 0x0000012e,
  IH_PERF_SEL_RB2_RPTR_WRAP_VF9 = 0x0000012f,
  IH_PERF_SEL_RB2_RPTR_WRAP_VF10 = 0x00000130,
  IH_PERF_SEL_RB2_RPTR_WRAP_VF11 = 0x00000131,
  IH_PERF_SEL_RB2_RPTR_WRAP_VF12 = 0x00000132,
  IH_PERF_SEL_RB2_RPTR_WRAP_VF13 = 0x00000133,
  IH_PERF_SEL_RB2_RPTR_WRAP_VF14 = 0x00000134,
  IH_PERF_SEL_RB2_RPTR_WRAP_VF15 = 0x00000135,
  IH_PERF_SEL_RB0_FULL_DRAIN_DROP = 0x00000136,
  IH_PERF_SEL_RB0_FULL_DRAIN_DROP_VF0 = 0x00000137,
  IH_PERF_SEL_RB0_FULL_DRAIN_DROP_VF1 = 0x00000138,
  IH_PERF_SEL_RB0_FULL_DRAIN_DROP_VF2 = 0x00000139,
  IH_PERF_SEL_RB0_FULL_DRAIN_DROP_VF3 = 0x0000013a,
  IH_PERF_SEL_RB0_FULL_DRAIN_DROP_VF4 = 0x0000013b,
  IH_PERF_SEL_RB0_FULL_DRAIN_DROP_VF5 = 0x0000013c,
  IH_PERF_SEL_RB0_FULL_DRAIN_DROP_VF6 = 0x0000013d,
  IH_PERF_SEL_RB0_FULL_DRAIN_DROP_VF7 = 0x0000013e,
  IH_PERF_SEL_RB0_FULL_DRAIN_DROP_VF8 = 0x0000013f,
  IH_PERF_SEL_RB0_FULL_DRAIN_DROP_VF9 = 0x00000140,
  IH_PERF_SEL_RB0_FULL_DRAIN_DROP_VF10 = 0x00000141,
  IH_PERF_SEL_RB0_FULL_DRAIN_DROP_VF11 = 0x00000142,
  IH_PERF_SEL_RB0_FULL_DRAIN_DROP_VF12 = 0x00000143,
  IH_PERF_SEL_RB0_FULL_DRAIN_DROP_VF13 = 0x00000144,
  IH_PERF_SEL_RB0_FULL_DRAIN_DROP_VF14 = 0x00000145,
  IH_PERF_SEL_RB0_FULL_DRAIN_DROP_VF15 = 0x00000146,
  IH_PERF_SEL_RB0_FULL_DRAIN_DROP_VF16 = 0x00000147,
  IH_PERF_SEL_RB1_FULL_DRAIN_DROP = 0x00000148,
  IH_PERF_SEL_RB1_FULL_DRAIN_DROP_VF0 = 0x00000149,
  IH_PERF_SEL_RB1_FULL_DRAIN_DROP_VF1 = 0x0000014a,
  IH_PERF_SEL_RB1_FULL_DRAIN_DROP_VF2 = 0x0000014b,
  IH_PERF_SEL_RB1_FULL_DRAIN_DROP_VF3 = 0x0000014c,
  IH_PERF_SEL_RB1_FULL_DRAIN_DROP_VF4 = 0x0000014d,
  IH_PERF_SEL_RB1_FULL_DRAIN_DROP_VF5 = 0x0000014e,
  IH_PERF_SEL_RB1_FULL_DRAIN_DROP_VF6 = 0x0000014f,
  IH_PERF_SEL_RB1_FULL_DRAIN_DROP_VF7 = 0x00000150,
  IH_PERF_SEL_RB1_FULL_DRAIN_DROP_VF8 = 0x00000151,
  IH_PERF_SEL_RB1_FULL_DRAIN_DROP_VF9 = 0x00000152,
  IH_PERF_SEL_RB1_FULL_DRAIN_DROP_VF10 = 0x00000153,
  IH_PERF_SEL_RB1_FULL_DRAIN_DROP_VF11 = 0x00000154,
  IH_PERF_SEL_RB1_FULL_DRAIN_DROP_VF12 = 0x00000155,
  IH_PERF_SEL_RB1_FULL_DRAIN_DROP_VF13 = 0x00000156,
  IH_PERF_SEL_RB1_FULL_DRAIN_DROP_VF14 = 0x00000157,
  IH_PERF_SEL_RB1_FULL_DRAIN_DROP_VF15 = 0x00000158,
  IH_PERF_SEL_RB1_FULL_DRAIN_DROP_VF16 = 0x00000159,
  IH_PERF_SEL_RB2_FULL_DRAIN_DROP = 0x0000015a,
  IH_PERF_SEL_RB2_FULL_DRAIN_DROP_VF0 = 0x0000015b,
  IH_PERF_SEL_RB2_FULL_DRAIN_DROP_VF1 = 0x0000015c,
  IH_PERF_SEL_RB2_FULL_DRAIN_DROP_VF2 = 0x0000015d,
  IH_PERF_SEL_RB2_FULL_DRAIN_DROP_VF3 = 0x0000015e,
  IH_PERF_SEL_RB2_FULL_DRAIN_DROP_VF4 = 0x0000015f,
  IH_PERF_SEL_RB2_FULL_DRAIN_DROP_VF5 = 0x00000160,
  IH_PERF_SEL_RB2_FULL_DRAIN_DROP_VF6 = 0x00000161,
  IH_PERF_SEL_RB2_FULL_DRAIN_DROP_VF7 = 0x00000162,
  IH_PERF_SEL_RB2_FULL_DRAIN_DROP_VF8 = 0x00000163,
  IH_PERF_SEL_RB2_FULL_DRAIN_DROP_VF9 = 0x00000164,
  IH_PERF_SEL_RB2_FULL_DRAIN_DROP_VF10 = 0x00000165,
  IH_PERF_SEL_RB2_FULL_DRAIN_DROP_VF11 = 0x00000166,
  IH_PERF_SEL_RB2_FULL_DRAIN_DROP_VF12 = 0x00000167,
  IH_PERF_SEL_RB2_FULL_DRAIN_DROP_VF13 = 0x00000168,
  IH_PERF_SEL_RB2_FULL_DRAIN_DROP_VF14 = 0x00000169,
  IH_PERF_SEL_RB2_FULL_DRAIN_DROP_VF15 = 0x0000016a,
  IH_PERF_SEL_RB2_FULL_DRAIN_DROP_VF16 = 0x0000016b,
  ...
  Reserved380 = 0x0000017c,
  Reserved381 = 0x0000017d,
  Reserved382 = 0x0000017e,
  Reserved383 = 0x0000017f,
  Reserved384 = 0x00000180,
  Reserved385 = 0x00000181,
  Reserved386 = 0x00000182,
  Reserved387 = 0x00000183,
  Reserved388 = 0x00000184,
  Reserved389 = 0x00000185,
  Reserved390 = 0x00000186,
  Reserved391 = 0x00000187,
  Reserved392 = 0x00000188,
  Reserved393 = 0x00000189,
  Reserved394 = 0x0000018a,
  Reserved395 = 0x0000018b,
  Reserved396 = 0x0000018c,
  Reserved397 = 0x0000018d,
  Reserved398 = 0x0000018e,
  Reserved399 = 0x0000018f,
  Reserved400 = 0x00000190,
  Reserved401 = 0x00000191,
  Reserved402 = 0x00000192,
  Reserved403 = 0x00000193,
  Reserved404 = 0x00000194,
  Reserved405 = 0x00000195,
  Reserved406 = 0x00000196,
  Reserved407 = 0x00000197,
  Reserved408 = 0x00000198,
  Reserved409 = 0x00000199,
  Reserved410 = 0x0000019a,
  Reserved411 = 0x0000019b,
...
typedef enum SPI_PERFCNT_SEL {
  ...
  SPI_PERF_PS_WINDOW_VALID = 0x00000035,
  SPI_PERF_PS_BUSY = 0x00000036,
  SPI_PERF_PS_ACTIVE = 0x00000037,
  SPI_PERF_PS_DEALLOC_BIN0 = 0x00000038,
  SPI_PERF_PS_FPOS_BIN1_STALL = 0x00000039,
  SPI_PERF_PS_EVENT_WAVE = 0x0000003a,
  SPI_PERF_PS_WAVE = 0x0000003b,
  SPI_PERF_PS_OPT_WAVE = 0x0000003c,
  SPI_PERF_PS_PASS_BIN0 = 0x0000003d,
  SPI_PERF_PS_PASS_BIN1 = 0x0000003e,
  SPI_PERF_PS_FPOS_BIN2 = 0x0000003f,
  SPI_PERF_PS_PRIM_BIN0 = 0x00000040,
  SPI_PERF_PS_PRIM_BIN1 = 0x00000041,
  SPI_PERF_PS_CNF_BIN2 = 0x00000042,
  SPI_PERF_PS_CNF_BIN3 = 0x00000043,
  SPI_PERF_PS_CRAWLER_STALL = 0x00000044,
  SPI_PERF_PS_LDS_RES_FULL = 0x00000045,
  SPI_PERF_PS_PERS_UPD_FULL0 = 0x00000046,
  SPI_PERF_PS_PERS_UPD_FULL1 = 0x00000047,
  SPI_PERF_PS_POPS_WAVE_SENT = 0x00000048,
  SPI_PERF_PS_POPS_WAVE_EXIT = 0x00000049,
  SPI_PERF_LDS0_PC_VALID = 0x0000004a,
  SPI_PERF_LDS1_PC_VALID = 0x0000004b,
  SPI_PERF_RA_PIPE_REQ_BIN2 = 0x0000004c,
  SPI_PERF_RA_TASK_REQ_BIN3 = 0x0000004d,
  SPI_PERF_RA_WR_CTL_FULL = 0x0000004e,
  SPI_PERF_RA_REQ_NO_ALLOC = 0x0000004f,
  SPI_PERF_RA_REQ_NO_ALLOC_PS = 0x00000050,
  SPI_PERF_RA_REQ_NO_ALLOC_VS = 0x00000051,
  SPI_PERF_RA_REQ_NO_ALLOC_GS = 0x00000052,
  SPI_PERF_RA_REQ_NO_ALLOC_HS = 0x00000053,
  SPI_PERF_RA_REQ_NO_ALLOC_CSG = 0x00000054,
  SPI_PERF_RA_REQ_NO_ALLOC_CSN = 0x00000055,
  SPI_PERF_RA_RES_STALL_PS = 0x00000056,
  SPI_PERF_RA_RES_STALL_VS = 0x00000057,
  SPI_PERF_RA_RES_STALL_GS = 0x00000058,
  SPI_PERF_RA_RES_STALL_HS = 0x00000059,
  SPI_PERF_RA_RES_STALL_CSG = 0x0000005a,
  SPI_PERF_RA_RES_STALL_CSN = 0x0000005b,
  SPI_PERF_RA_TMP_STALL_PS = 0x0000005c,
  SPI_PERF_RA_TMP_STALL_VS = 0x0000005d,
  SPI_PERF_RA_TMP_STALL_GS = 0x0000005e,
  SPI_PERF_RA_TMP_STALL_HS = 0x0000005f,
  SPI_PERF_RA_TMP_STALL_CSG = 0x00000060,
  SPI_PERF_RA_TMP_STALL_CSN = 0x00000061,
  SPI_PERF_RA_WAVE_SIMD_FULL_PS = 0x00000062,
  SPI_PERF_RA_WAVE_SIMD_FULL_VS = 0x00000063,
  SPI_PERF_RA_WAVE_SIMD_FULL_GS = 0x00000064,
  SPI_PERF_RA_WAVE_SIMD_FULL_HS = 0x00000065,
  SPI_PERF_RA_WAVE_SIMD_FULL_CSG = 0x00000066,
  SPI_PERF_RA_WAVE_SIMD_FULL_CSN = 0x00000067,
  SPI_PERF_RA_VGPR_SIMD_FULL_PS = 0x00000068,
  SPI_PERF_RA_VGPR_SIMD_FULL_VS = 0x00000069,
  SPI_PERF_RA_VGPR_SIMD_FULL_GS = 0x0000006a,
  SPI_PERF_RA_VGPR_SIMD_FULL_HS = 0x0000006b,
  SPI_PERF_RA_VGPR_SIMD_FULL_CSG = 0x0000006c,
  SPI_PERF_RA_VGPR_SIMD_FULL_CSN = 0x0000006d,
  SPI_PERF_RA_SGPR_SIMD_FULL_PS = 0x0000006e,
  SPI_PERF_RA_SGPR_SIMD_FULL_VS = 0x0000006f,
  SPI_PERF_RA_SGPR_SIMD_FULL_GS = 0x00000070,
  SPI_PERF_RA_SGPR_SIMD_FULL_HS = 0x00000071,
  SPI_PERF_RA_SGPR_SIMD_FULL_CSG = 0x00000072,
  SPI_PERF_RA_SGPR_SIMD_FULL_CSN = 0x00000073,
  SPI_PERF_RA_LDS_CU_FULL_PS = 0x00000074,
  SPI_PERF_RA_LDS_CU_FULL_LS = 0x00000075,
  SPI_PERF_RA_LDS_CU_FULL_ES = 0x00000076,
  SPI_PERF_RA_LDS_CU_FULL_CSG = 0x00000077,
  SPI_PERF_RA_LDS_CU_FULL_CSN = 0x00000078,
  SPI_PERF_RA_BAR_CU_FULL_HS = 0x00000079,
  SPI_PERF_RA_BAR_CU_FULL_CSG = 0x0000007a,
  SPI_PERF_RA_BAR_CU_FULL_CSN = 0x0000007b,
  SPI_PERF_RA_BULKY_CU_FULL_CSG = 0x0000007c,
  SPI_PERF_RA_BULKY_CU_FULL_CSN = 0x0000007d,
  SPI_PERF_RA_TGLIM_CU_FULL_CSG = 0x0000007e,
  SPI_PERF_RA_TGLIM_CU_FULL_CSN = 0x0000007f,
  SPI_PERF_RA_WVLIM_STALL_PS = 0x00000080,
  SPI_PERF_RA_WVLIM_STALL_VS = 0x00000081,
  SPI_PERF_RA_WVLIM_STALL_GS = 0x00000082,
  SPI_PERF_RA_WVLIM_STALL_HS = 0x00000083,
  SPI_PERF_RA_WVLIM_STALL_CSG = 0x00000084,
  SPI_PERF_RA_WVLIM_STALL_CSN = 0x00000085,
  SPI_PERF_RA_VS_LOCK = 0x00000086,
  SPI_PERF_RA_GS_LOCK = 0x00000087,
  SPI_PERF_RA_HS_LOCK = 0x00000088,
  SPI_PERF_RA_CSG_LOCK = 0x00000089,
  SPI_PERF_RA_CSN_LOCK = 0x0000008a,
  SPI_PERF_RA_RSV_UPD = 0x0000008b,
  SPI_PERF_EXP_ARB_COL_CNT = 0x0000008c,
  SPI_PERF_EXP_ARB_PAR_CNT = 0x0000008d,
  SPI_PERF_EXP_ARB_POS_CNT = 0x0000008e,
  SPI_PERF_EXP_ARB_GDS_CNT = 0x0000008f,
  SPI_PERF_NUM_PS_COL_R0_EXPORTS = 0x00000090,
  SPI_PERF_NUM_PS_COL_R1_EXPORTS = 0x00000091,
  SPI_PERF_NUM_VS_POS_R0_EXPORTS = 0x00000092,
  SPI_PERF_NUM_VS_POS_R1_EXPORTS = 0x00000093,
  SPI_PERF_NUM_VS_PARAM_R0_EXPORTS = 0x00000094,
  SPI_PERF_NUM_VS_PARAM_R1_EXPORTS = 0x00000095,
  SPI_PERF_NUM_VS_GDS_R0_EXPORTS = 0x00000096,
  SPI_PERF_NUM_VS_GDS_R1_EXPORTS = 0x00000097,
  SPI_PERF_NUM_EXPGRANT_EXPORTS = 0x00000098,
  SPI_PERF_CLKGATE_BUSY_STALL = 0x00000099,
  SPI_PERF_CLKGATE_ACTIVE_STALL = 0x0000009a,
  SPI_PERF_CLKGATE_ALL_CLOCKS_ON = 0x0000009b,
  SPI_PERF_CLKGATE_CGTT_DYN_ON = 0x0000009c,
  SPI_PERF_CLKGATE_CGTT_REG_ON = 0x0000009d,
  SPI_PERF_PIX_ALLOC_PEND_CNT = 0x0000009e,
  SPI_PERF_PIX_ALLOC_SCB_STALL = 0x0000009f,
  SPI_PERF_PIX_ALLOC_DB0_STALL = 0x000000a0,
  SPI_PERF_PIX_ALLOC_DB1_STALL = 0x000000a1,
  SPI_PERF_PIX_ALLOC_DB2_STALL = 0x000000a2,
  SPI_PERF_PIX_ALLOC_DB3_STALL = 0x000000a3,
  SPI_PERF_PC_ALLOC_ACCUM = 0x000000a4,
  SPI_PERF_GS_NGG_SE_HAS_BATON = 0x000000a5,
  SPI_PERF_GS_NGG_SE_DOES_NOT_HAVE_BATON = 0x000000a6,
  SPI_PERF_GS_NGG_SE_FORWARDED_BATON = 0x000000a7,
  SPI_PERF_GS_NGG_SE_AT_SYNC_EVENT = 0x000000a8,
  SPI_PERF_GS_NGG_SE_SG_ALLOC_PC_SPACE_CNT = 0x000000a9,
  SPI_PERF_GS_NGG_SE_DEALLOC_PC_SPACE_CNT = 0x000000aa,
  SPI_PERF_GS_NGG_PC_FULL = 0x000000ab,
  SPI_PERF_GS_NGG_SE_SEND_GS_ALLOC = 0x000000ac,
  SPI_PERF_GS_NGG_GS_ALLOC_FIFO_EMPTY = 0x000000ad,
  SPI_PERF_GSC_VTX_BUSY = 0x000000ae,
  SPI_PERF_GSC_VTX_INPUT_STARVED = 0x000000af,
  SPI_PERF_GSC_VTX_VSR_STALL = 0x000000b0,
  SPI_PERF_GSC_VTX_VSR_FULL = 0x000000b1,
  SPI_PERF_GSC_VTX_CAC_BUSY = 0x000000b2,
  SPI_PERF_ESC_VTX_BUSY = 0x000000b3,
  SPI_PERF_ESC_VTX_INPUT_STARVED = 0x000000b4,
  SPI_PERF_ESC_VTX_VSR_STALL = 0x000000b5,
  SPI_PERF_ESC_VTX_VSR_FULL = 0x000000b6,
  SPI_PERF_ESC_VTX_CAC_BUSY = 0x000000b7,
  SPI_PERF_SWC_PS_WR = 0x000000b8,
  SPI_PERF_SWC_VS_WR = 0x000000b9,
  SPI_PERF_SWC_GS_WR = 0x000000ba,
  SPI_PERF_SWC_HS_WR = 0x000000bb,
  SPI_PERF_SWC_CSG_WR = 0x000000bc,
  SPI_PERF_SWC_CSC_WR = 0x000000bd,
  SPI_PERF_VWC_PS_WR = 0x000000be,
  SPI_PERF_VWC_VS_WR = 0x000000bf,
  SPI_PERF_VWC_GS_WR = 0x000000c0,
  SPI_PERF_VWC_HS_WR = 0x000000c1,
  SPI_PERF_VWC_CSG_WR = 0x000000c2,
...
typedef enum SQ_PERF_SEL {
  ...
  SQ_PERF_SEL_TA_STARVE = 0x00000065,
  SQ_PERF_SEL_EXP_REQ_FIFO_FULL = 0x00000066,
  SQ_PERF_SEL_LDS_DATA_FIFO_FULL = 0x00000067,
  SQ_PERF_SEL_LDS_CMD_FIFO_FULL = 0x00000068,
  SQ_PERF_SEL_VMEM_TA_ADDR_FIFO_FULL = 0x00000069,
  SQ_PERF_SEL_VMEM_TA_CMD_FIFO_FULL = 0x0000006a,
  SQ_PERF_SEL_VMEM_EX_DATA_REG_BUSY = 0x0000006b,
  SQ_PERF_SEL_VMEM_WR_TA_DATA_FIFO_FULL = 0x0000006c,
  SQ_PERF_SEL_VALU_SRC_C_CONFLICT = 0x0000006d,
  SQ_PERF_SEL_VMEM_RD_SRC_CD_CONFLICT = 0x0000006e,
  SQ_PERF_SEL_VMEM_WR_SRC_CD_CONFLICT = 0x0000006f,
  SQ_PERF_SEL_FLAT_SRC_CD_CONFLICT = 0x00000070,
  SQ_PERF_SEL_LDS_SRC_CD_CONFLICT = 0x00000071,
  SQ_PERF_SEL_SRC_CD_BUSY = 0x00000072,
  SQ_PERF_SEL_PT_POWER_STALL = 0x00000073,
  SQ_PERF_SEL_USER0 = 0x00000074,
  SQ_PERF_SEL_USER1 = 0x00000075,
  SQ_PERF_SEL_USER2 = 0x00000076,
  SQ_PERF_SEL_USER3 = 0x00000077,
  SQ_PERF_SEL_USER4 = 0x00000078,
  SQ_PERF_SEL_USER5 = 0x00000079,
  SQ_PERF_SEL_USER6 = 0x0000007a,
  SQ_PERF_SEL_USER7 = 0x0000007b,
  SQ_PERF_SEL_USER8 = 0x0000007c,
  SQ_PERF_SEL_USER9 = 0x0000007d,
  SQ_PERF_SEL_USER10 = 0x0000007e,
  SQ_PERF_SEL_USER11 = 0x0000007f,
  SQ_PERF_SEL_USER12 = 0x00000080,
  SQ_PERF_SEL_USER13 = 0x00000081,
  SQ_PERF_SEL_USER14 = 0x00000082,
  SQ_PERF_SEL_USER15 = 0x00000083,
  SQ_PERF_SEL_USER_LEVEL0 = 0x00000084,
  SQ_PERF_SEL_USER_LEVEL1 = 0x00000085,
  SQ_PERF_SEL_USER_LEVEL2 = 0x00000086,
  SQ_PERF_SEL_USER_LEVEL3 = 0x00000087,
  SQ_PERF_SEL_USER_LEVEL4 = 0x00000088,
  SQ_PERF_SEL_USER_LEVEL5 = 0x00000089,
  SQ_PERF_SEL_USER_LEVEL6 = 0x0000008a,
  SQ_PERF_SEL_USER_LEVEL7 = 0x0000008b,
  SQ_PERF_SEL_USER_LEVEL8 = 0x0000008c,
  SQ_PERF_SEL_USER_LEVEL9 = 0x0000008d,
  SQ_PERF_SEL_USER_LEVEL10 = 0x0000008e,
  SQ_PERF_SEL_USER_LEVEL11 = 0x0000008f,
  SQ_PERF_SEL_USER_LEVEL12 = 0x00000090,
  SQ_PERF_SEL_USER_LEVEL13 = 0x00000091,
  SQ_PERF_SEL_USER_LEVEL14 = 0x00000092,
  SQ_PERF_SEL_USER_LEVEL15 = 0x00000093,
  SQ_PERF_SEL_POWER_VALU = 0x00000094,
  SQ_PERF_SEL_POWER_VALU0 = 0x00000095,
  SQ_PERF_SEL_POWER_VALU1 = 0x00000096,
  SQ_PERF_SEL_POWER_VALU2 = 0x00000097,
  SQ_PERF_SEL_POWER_GPR_RD = 0x00000098,
  SQ_PERF_SEL_POWER_GPR_WR = 0x00000099,
  SQ_PERF_SEL_POWER_LDS_BUSY = 0x0000009a,
  SQ_PERF_SEL_POWER_ALU_BUSY = 0x0000009b,
  SQ_PERF_SEL_POWER_TEX_BUSY = 0x0000009c,
  SQ_PERF_SEL_ACCUM_PREV_HIRES = 0x0000009d,
  SQ_PERF_SEL_WAVES_RESTORED = 0x0000009e,
  SQ_PERF_SEL_WAVES_SAVED = 0x0000009f,
  SQ_PERF_SEL_INSTS_SMEM_NORM = 0x000000a0,
  SQ_PERF_SEL_XNACK_FIRST = 0x000000a1,
  SQ_PERF_SEL_XNACK_ALL = 0x000000a2,
  SQ_PERF_SEL_XNACK_FIFO_FULL = 0x000000a3,
  SQ_PERF_SEL_IFETCH_XNACK = 0x000000a4,
  SQ_PERF_SEL_TLB_SHOOTDOWN = 0x000000a5,
  SQ_PERF_SEL_TLB_SHOOTDOWN_CYCLES = 0x000000a6,
  SQ_PERF_SEL_INSTS_VMEM_WR_REPLAY = 0x000000a7,
  SQ_PERF_SEL_INSTS_VMEM_RD_REPLAY = 0x000000a8,
  SQ_PERF_SEL_INSTS_VMEM_REPLAY = 0x000000a9,
  SQ_PERF_SEL_INSTS_SMEM_REPLAY = 0x000000aa,
  SQ_PERF_SEL_INSTS_SMEM_NORM_REPLAY = 0x000000ab,
  SQ_PERF_SEL_INSTS_FLAT_REPLAY = 0x000000ac,
  SQ_PERF_SEL_UTCL1_TRANSLATION_MISS = 0x000000ad,
  SQ_PERF_SEL_UTCL1_PERMISSION_MISS = 0x000000ae,
  SQ_PERF_SEL_UTCL1_TRANSLATION_HIT_EVENT = 0x000000af,
  SQ_PERF_SEL_UTCL1_REQUEST = 0x000000b0,
  SQ_PERF_SEL_UTCL1_STALL_MISSFIFO_FULL = 0x000000b1,
  SQ_PERF_SEL_UTCL1_STALL_INFLIGHT_MAX = 0x000000b2,
  SQ_PERF_SEL_UTCL1_STALL_LRU_INFLIGHT = 0x000000b3,
  SQ_PERF_SEL_UTCL1_LFIFO_FULL = 0x000000b4,
  SQ_PERF_SEL_UTCL1_STALL_LFIFO_NOT_RES = 0x000000b5,
  SQ_PERF_SEL_UTCL1_STALL_UTCL2_REQ_OUT_OF_CREDITS = 0x000000b6,
  SQ_PERF_SEL_DUMMY_END = 0x000000b7,
  ...
  SQC_PERF_SEL_ICACHE_GATCL1_TRANSLATION_HIT = 0x00000157,
  SQC_PERF_SEL_ICACHE_GATCL1_REQUEST = 0x00000158,
  SQC_PERF_SEL_ICACHE_GATCL1_STALL_INFLIGHT_MAX = 0x00000159,
  SQC_PERF_SEL_ICACHE_GATCL1_STALL_LRU_INFLIGHT = 0x0000015a,
  SQC_PERF_SEL_ICACHE_GATCL1_LFIFO_FULL = 0x0000015b,
  SQC_PERF_SEL_ICACHE_GATCL1_STALL_LFIFO_NOT_RES = 0x0000015c,
  SQC_PERF_SEL_ICACHE_GATCL1_STALL_ATCL2_REQ_OUT_OF_CREDITS = 0x0000015d,
  SQC_PERF_SEL_ICACHE_GATCL1_ATCL2_INFLIGHT = 0x0000015e,
  SQC_PERF_SEL_ICACHE_GATCL1_STALL_MISSFIFO_FULL = 0x0000015f,
  SQC_PERF_SEL_DCACHE_GATCL1_TRANSLATION_MISS = 0x00000160,
  SQC_PERF_SEL_DCACHE_GATCL1_PERMISSION_MISS = 0x00000161,
  SQC_PERF_SEL_DCACHE_GATCL1_TRANSLATION_HIT = 0x00000162,
  SQC_PERF_SEL_DCACHE_GATCL1_REQUEST = 0x00000163,
  SQC_PERF_SEL_DCACHE_GATCL1_STALL_INFLIGHT_MAX = 0x00000164,
  SQC_PERF_SEL_DCACHE_GATCL1_STALL_LRU_INFLIGHT = 0x00000165,
  SQC_PERF_SEL_DCACHE_GATCL1_LFIFO_FULL = 0x00000166,
  SQC_PERF_SEL_DCACHE_GATCL1_STALL_LFIFO_NOT_RES = 0x00000167,
  SQC_PERF_SEL_DCACHE_GATCL1_STALL_ATCL2_REQ_OUT_OF_CREDITS = 0x00000168,
  SQC_PERF_SEL_DCACHE_GATCL1_ATCL2_INFLIGHT = 0x00000169,
  SQC_PERF_SEL_DCACHE_GATCL1_STALL_MISSFIFO_FULL = 0x0000016a,
  SQC_PERF_SEL_DCACHE_GATCL1_STALL_MULTI_MISS = 0x0000016b,
  SQC_PERF_SEL_DCACHE_GATCL1_HIT_FIFO_FULL = 0x0000016c,
  SQC_PERF_SEL_ICACHE_UTCL1_INFLIGHT_LEVEL = 0x0000016d,
  SQC_PERF_SEL_ICACHE_UTCL1_ALL_REQ = 0x0000016e,
  SQC_PERF_SEL_ICACHE_UTCL2_INFLIGHT_LEVEL = 0x0000016f,
  SQC_PERF_SEL_ICACHE_UTCL2_ALL_REQ = 0x00000170,
  SQC_PERF_SEL_DCACHE_UTCL1_INFLIGHT_LEVEL = 0x00000171,
  SQC_PERF_SEL_DCACHE_UTCL1_ALL_REQ = 0x00000172,
  SQC_PERF_SEL_DCACHE_UTCL2_INFLIGHT_LEVEL = 0x00000173,
  SQC_PERF_SEL_DCACHE_UTCL2_ALL_REQ = 0x00000174,
...
typedef enum IA_PERFCOUNT_SELECT {
  ...
  ia_perf_utcl1_request_event_1 = 0x0000001d,
  ia_perf_utcl1_request_event_0 = 0x0000001e,
...
typedef enum TD_PERFCOUNT_SEL {
  ...
  TD_PERF_SEL_output_fifo_full = 0x0000000b,
  TD_PERF_SEL_RESERVED_12 = 0x0000000c,
  TD_PERF_SEL_RESERVED_13 = 0x0000000d,
...
typedef enum TCP_PERFCOUNT_SELECT {
  ...
  TCP_PERF_SEL_UTCL1_SERIALIZATION_STALL = 0x00000019,
  TCP_PERF_SEL_TC_TA_XNACK_STALL = 0x0000001a,
  TCP_PERF_SEL_TA_TCP_STATE_READ = 0x0000001b,
  TCP_PERF_SEL_VOLATILE = 0x0000001c,
  TCP_PERF_SEL_TOTAL_ACCESSES = 0x0000001d,
  TCP_PERF_SEL_TOTAL_READ = 0x0000001e,
  TCP_PERF_SEL_TOTAL_NON_READ = 0x0000001f,
  TCP_PERF_SEL_TOTAL_WRITE = 0x00000020,
  TCP_PERF_SEL_TOTAL_HIT_LRU_READ = 0x00000021,
  TCP_PERF_SEL_TOTAL_MISS_LRU_READ = 0x00000022,
  TCP_PERF_SEL_TOTAL_MISS_EVICT_READ = 0x00000023,
  TCP_PERF_SEL_TOTAL_MISS_LRU_WRITE = 0x00000024,
  TCP_PERF_SEL_TOTAL_MISS_EVICT_WRITE = 0x00000025,
  TCP_PERF_SEL_TOTAL_ATOMIC_WITH_RET = 0x00000026,
  TCP_PERF_SEL_TOTAL_ATOMIC_WITHOUT_RET = 0x00000027,
  TCP_PERF_SEL_TOTAL_WBINVL1 = 0x00000028,
  TCP_PERF_SEL_TOTAL_WBINVL1_VOL = 0x00000029,
  TCP_PERF_SEL_SQ_TCP_INVALIDATE_VOL = 0x0000002a,
  TCP_PERF_SEL_CP_TCP_INVALIDATE = 0x0000002b,
  TCP_PERF_SEL_CP_TCP_INVALIDATE_VOL = 0x0000002c,
  TCP_PERF_SEL_TOTAL_WRITEBACK_INVALIDATES = 0x0000002d,
  TCP_PERF_SEL_SHOOTDOWN = 0x0000002e,
  TCP_PERF_SEL_UTCL1_REQUEST = 0x0000002f,
  TCP_PERF_SEL_UTCL1_TRANSLATION_MISS = 0x00000030,
  TCP_PERF_SEL_UTCL1_TRANSLATION_HIT = 0x00000031,
  TCP_PERF_SEL_UTCL1_PERMISSION_MISS = 0x00000032,
  TCP_PERF_SEL_UTCL1_STALL_INFLIGHT_MAX = 0x00000033,
  TCP_PERF_SEL_UTCL1_STALL_LRU_INFLIGHT = 0x00000034,
  TCP_PERF_SEL_UTCL1_STALL_MULTI_MISS = 0x00000035,
  TCP_PERF_SEL_UTCL1_LFIFO_FULL = 0x00000036,
  TCP_PERF_SEL_UTCL1_STALL_LFIFO_NOT_RES = 0x00000037,
  TCP_PERF_SEL_UTCL1_STALL_UTCL2_REQ_OUT_OF_CREDITS = 0x00000038,
  TCP_PERF_SEL_CLIENT_UTCL1_INFLIGHT = 0x00000039,
  TCP_PERF_SEL_UTCL1_UTCL2_INFLIGHT = 0x0000003a,
  TCP_PERF_SEL_UTCL1_STALL_MISSFIFO_FULL = 0x0000003b,
  TCP_PERF_SEL_TOTAL_CACHE_ACCESSES = 0x0000003c,
  TCP_PERF_SEL_TAGRAM0_REQ = 0x0000003d,
  TCP_PERF_SEL_TAGRAM1_REQ = 0x0000003e,
  TCP_PERF_SEL_TAGRAM2_REQ = 0x0000003f,
  TCP_PERF_SEL_TAGRAM3_REQ = 0x00000040,
  TCP_PERF_SEL_TCP_LATENCY = 0x00000041,
  TCP_PERF_SEL_TCC_READ_REQ_LATENCY = 0x00000042,
  TCP_PERF_SEL_TCC_WRITE_REQ_LATENCY = 0x00000043,
  TCP_PERF_SEL_TCC_WRITE_REQ_HOLE_LATENCY = 0x00000044,
  TCP_PERF_SEL_TCC_READ_REQ = 0x00000045,
  TCP_PERF_SEL_TCC_WRITE_REQ = 0x00000046,
  TCP_PERF_SEL_TCC_ATOMIC_WITH_RET_REQ = 0x00000047,
  TCP_PERF_SEL_TCC_ATOMIC_WITHOUT_RET_REQ = 0x00000048,
  TCP_PERF_SEL_TCC_LRU_REQ = 0x00000049,
  TCP_PERF_SEL_TCC_STREAM_REQ = 0x0000004a,
  TCP_PERF_SEL_TCC_NC_READ_REQ = 0x0000004b,
  TCP_PERF_SEL_TCC_NC_WRITE_REQ = 0x0000004c,
  TCP_PERF_SEL_TCC_NC_ATOMIC_REQ = 0x0000004d,
  TCP_PERF_SEL_TCC_UC_READ_REQ = 0x0000004e,
  TCP_PERF_SEL_TCC_UC_WRITE_REQ = 0x0000004f,
  TCP_PERF_SEL_TCC_UC_ATOMIC_REQ = 0x00000050,
  TCP_PERF_SEL_TCC_CC_READ_REQ = 0x00000051,
  TCP_PERF_SEL_TCC_CC_WRITE_REQ = 0x00000052,
  TCP_PERF_SEL_TCC_CC_ATOMIC_REQ = 0x00000053,
...
typedef enum TCC_PERF_SEL {
  ...
  TCC_PERF_SEL_EA_WRREQ = 0x0000001d,
  TCC_PERF_SEL_EA_WRREQ_64B = 0x0000001e,
  TCC_PERF_SEL_EA_WRREQ_PROBE_COMMAND = 0x0000001f,
  TCC_PERF_SEL_EA_WR_UNCACHED_32B = 0x00000020,
  TCC_PERF_SEL_EA_WRREQ_STALL = 0x00000021,
  TCC_PERF_SEL_EA_WRREQ_IO_CREDIT_STALL = 0x00000022,
  TCC_PERF_SEL_EA_WRREQ_GMI_CREDIT_STALL = 0x00000023,
  TCC_PERF_SEL_EA_WRREQ_DRAM_CREDIT_STALL = 0x00000024,
  TCC_PERF_SEL_TOO_MANY_EA_WRREQS_STALL = 0x00000025,
  TCC_PERF_SEL_EA_WRREQ_LEVEL = 0x00000026,
  TCC_PERF_SEL_EA_ATOMIC = 0x00000027,
  TCC_PERF_SEL_EA_ATOMIC_LEVEL = 0x00000028,
  TCC_PERF_SEL_EA_RDREQ = 0x00000029,
  TCC_PERF_SEL_EA_RDREQ_32B = 0x0000002a,
  TCC_PERF_SEL_EA_RD_UNCACHED_32B = 0x0000002b,
  TCC_PERF_SEL_EA_RD_MDC_32B = 0x0000002c,
  TCC_PERF_SEL_EA_RD_COMPRESSED_32B = 0x0000002d,
  TCC_PERF_SEL_EA_RDREQ_IO_CREDIT_STALL = 0x0000002e,
  TCC_PERF_SEL_EA_RDREQ_GMI_CREDIT_STALL = 0x0000002f,
  TCC_PERF_SEL_EA_RDREQ_DRAM_CREDIT_STALL = 0x00000030,
  TCC_PERF_SEL_EA_RDREQ_LEVEL = 0x00000031,
  ...
  TCC_PERF_SEL_EA_RDRET_NACK = 0x00000048,
  TCC_PERF_SEL_EA_WRRET_NACK = 0x00000049,
  ...
  TCC_PERF_SEL_TC_OP_INV_METADATA = 0x0000006a,
...
typedef enum CPG_PERFCOUNT_SEL {
  ...
  CPG_PERF_SEL_CPG_STAT_BUSY = 0x00000032,
  CPG_PERF_SEL_CPG_STAT_IDLE = 0x00000033,
  CPG_PERF_SEL_CPG_STAT_STALL = 0x00000034,
  CPG_PERF_SEL_CPG_TCIU_BUSY = 0x00000035,
  CPG_PERF_SEL_CPG_TCIU_IDLE = 0x00000036,
  CPF_PERF_SEL_CPG_TCIU_STALL = 0x00000037,
  CPG_PERF_SEL_CPG_UTCL2IU_BUSY = 0x00000038,
  CPG_PERF_SEL_CPG_UTCL2IU_IDLE = 0x00000039,
...
typedef enum CPF_PERFCOUNT_SEL {
  ...
  CPF_PERF_SEL_TCIU_READ_REQUEST_SENT = 0x00000016,
  CPF_PERF_SEL_CPF_STAT_BUSY = 0x00000017,
  CPF_PERF_SEL_CPF_STAT_IDLE = 0x00000018,
  CPF_PERF_SEL_CPF_STAT_STALL = 0x00000019,
  CPF_PERF_SEL_CPF_TCIU_BUSY = 0x0000001a,
  CPF_PERF_SEL_CPF_TCIU_IDLE = 0x0000001b,
  CPF_PERF_SEL_CPF_TCIU_STALL = 0x0000001c,
  CPF_PERF_SEL_CPF_UTCL2IU_BUSY = 0x0000001d,
  CPF_PERF_SEL_CPF_UTCL2IU_IDLE = 0x0000001e,
...
typedef enum CPG_PERFCOUNTWINDOW_SEL {
  ...
  CPG_PERFWINDOW_SEL_RESERVED1 = 0x00000003,
  ...
  CPG_PERFWINDOW_SEL_MEMWR = 0x0000000f,
  CPG_PERFWINDOW_SEL_MEMRD = 0x00000010,
  CPG_PERFWINDOW_SEL_VGT0 = 0x00000011,
  CPG_PERFWINDOW_SEL_VGT1 = 0x00000012,
  CPG_PERFWINDOW_SEL_APPEND = 0x00000013,
  CPG_PERFWINDOW_SEL_QURD = 0x00000014,
  CPG_PERFWINDOW_SEL_CPCQU = 0x00000015,
  CPG_PERFWINDOW_SEL_SR = 0x00000016,
  CPG_PERFWINDOW_SEL_QU_EOP = 0x00000017,
  CPG_PERFWINDOW_SEL_QU_STRM = 0x00000018,
  CPG_PERFWINDOW_SEL_QU_PIPE = 0x00000019,
  CPG_PERFWINDOW_SEL_RESERVED2 = 0x0000001a,
  CPG_PERFWINDOW_SEL_CPC_IC = 0x0000001b,
  CPG_PERFWINDOW_SEL_SD = 0x0000001c,
...
typedef enum CPG_LATENCY_STATS_SEL {
  ...
  CPG_LATENCY_STATS_SEL_INVAL_MAX = 0x0000000c,
  CPG_LATENCY_STATS_SEL_INVAL_MIN = 0x0000000d,
  CPG_LATENCY_STATS_SEL_INVAL_LAST = 0x0000000e,
  CPG_LATENCY_STATS_SEL_ATOMIC_MAX = 0x0000000f,
  CPG_LATENCY_STATS_SEL_ATOMIC_MIN = 0x00000010,
  CPG_LATENCY_STATS_SEL_ATOMIC_LAST = 0x00000011,
...
/*
 * VALUE_SQ_WAITCNT_VM_HI_SIZE value
 */

#define SQ_WAITCNT_VM_HI_SIZE 0x00000002
...
/*
 * VALUE_SQ_WAITCNT_VM_HI_SHIFT value
 */

#define SQ_WAITCNT_VM_HI_SHIFT 0x0000000e
...
#define SQ_BUFFER_STORE_BYTE_D16_HI 0x00000019
#define SQ_BUFFER_STORE_SHORT 0x0000001a
#define SQ_BUFFER_STORE_SHORT_D16_HI 0x0000001b
...
#define SQ_BUFFER_LOAD_UBYTE_D16 0x00000020
#define SQ_BUFFER_LOAD_UBYTE_D16_HI 0x00000021
#define SQ_BUFFER_LOAD_SBYTE_D16 0x00000022
#define SQ_BUFFER_LOAD_SBYTE_D16_HI 0x00000023
#define SQ_BUFFER_LOAD_SHORT_D16 0x00000024
#define SQ_BUFFER_LOAD_SHORT_D16_HI 0x00000025
#define SQ_BUFFER_LOAD_FORMAT_D16_HI_X 0x00000026
#define SQ_BUFFER_STORE_FORMAT_D16_HI_X 0x00000027
...
#define SQ_GLOBAL_STORE_BYTE_D16_HI 0x00000019
#define SQ_GLOBAL_STORE_SHORT 0x0000001a
#define SQ_GLOBAL_STORE_SHORT_D16_HI 0x0000001b
...
#define SQ_GLOBAL_LOAD_UBYTE_D16 0x00000020
#define SQ_GLOBAL_LOAD_UBYTE_D16_HI 0x00000021
#define SQ_GLOBAL_LOAD_SBYTE_D16 0x00000022
#define SQ_GLOBAL_LOAD_SBYTE_D16_HI 0x00000023
#define SQ_GLOBAL_LOAD_SHORT_D16 0x00000024
#define SQ_GLOBAL_LOAD_SHORT_D16_HI 0x00000025
...
#define SQ_SCRATCH_STORE_BYTE_D16_HI 0x00000019
#define SQ_SCRATCH_STORE_SHORT 0x0000001a
#define SQ_SCRATCH_STORE_SHORT_D16_HI 0x0000001b
...
#define SQ_SCRATCH_LOAD_UBYTE_D16 0x00000020
#define SQ_SCRATCH_LOAD_UBYTE_D16_HI 0x00000021
#define SQ_SCRATCH_LOAD_SBYTE_D16 0x00000022
#define SQ_SCRATCH_LOAD_SBYTE_D16_HI 0x00000023
#define SQ_SCRATCH_LOAD_SHORT_D16 0x00000024
#define SQ_SCRATCH_LOAD_SHORT_D16_HI 0x00000025
...
#define SQ_S_DCACHE_DISCARD 0x00000028
#define SQ_S_DCACHE_DISCARD_X2 0x00000029
...
#define SQ_IMAGE_SAMPLE_A 0x000000a0
#define SQ_IMAGE_SAMPLE_CL_A 0x000000a1
#define SQ_IMAGE_SAMPLE_B_A 0x000000a5
#define SQ_IMAGE_SAMPLE_B_CL_A 0x000000a6
#define SQ_IMAGE_SAMPLE_C_A 0x000000a8
#define SQ_IMAGE_SAMPLE_C_CL_A 0x000000a9
#define SQ_IMAGE_SAMPLE_C_B_A 0x000000ad
#define SQ_IMAGE_SAMPLE_C_B_CL_A 0x000000ae
#define SQ_IMAGE_SAMPLE_O_A 0x000000b0
#define SQ_IMAGE_SAMPLE_CL_O_A 0x000000b1
#define SQ_IMAGE_SAMPLE_B_O_A 0x000000b5
#define SQ_IMAGE_SAMPLE_B_CL_O_A 0x000000b6
#define SQ_IMAGE_SAMPLE_C_O_A 0x000000b8
#define SQ_IMAGE_SAMPLE_C_CL_O_A 0x000000b9
#define SQ_IMAGE_SAMPLE_C_B_O_A 0x000000bd
#define SQ_IMAGE_SAMPLE_C_B_CL_O_A 0x000000be
#define SQ_IMAGE_GATHER4_A 0x000000c0
#define SQ_IMAGE_GATHER4_CL_A 0x000000c1
#define SQ_IMAGE_GATHER4_B_A 0x000000c5
#define SQ_IMAGE_GATHER4_B_CL_A 0x000000c6
#define SQ_IMAGE_GATHER4_C_A 0x000000c8
#define SQ_IMAGE_GATHER4_C_CL_A 0x000000c9
#define SQ_IMAGE_GATHER4_C_B_A 0x000000cd
#define SQ_IMAGE_GATHER4_C_B_CL_A 0x000000ce
#define SQ_IMAGE_GATHER4_O_A 0x000000d0
#define SQ_IMAGE_GATHER4_CL_O_A 0x000000d1
#define SQ_IMAGE_GATHER4_B_O_A 0x000000d5
#define SQ_IMAGE_GATHER4_B_CL_O_A 0x000000d6
#define SQ_IMAGE_GATHER4_C_O_A 0x000000d8
#define SQ_IMAGE_GATHER4_C_CL_O_A 0x000000d9
#define SQ_IMAGE_GATHER4_C_B_O_A 0x000000dd
#define SQ_IMAGE_GATHER4_C_B_CL_O_A 0x000000de
...
#define SQ_DS_WRITE_B8_D16_HI 0x00000054
#define SQ_DS_WRITE_B16_D16_HI 0x00000055
#define SQ_DS_READ_U8_D16 0x00000056
#define SQ_DS_READ_U8_D16_HI 0x00000057
#define SQ_DS_READ_I8_D16 0x00000058
#define SQ_DS_READ_I8_D16_HI 0x00000059
#define SQ_DS_READ_U16_D16 0x0000005a
#define SQ_DS_READ_U16_D16_HI 0x0000005b
...
#define SQ_FLAT_STORE_BYTE_D16_HI 0x00000019
#define SQ_FLAT_STORE_SHORT 0x0000001a
#define SQ_FLAT_STORE_SHORT_D16_HI 0x0000001b
...
#define SQ_FLAT_LOAD_UBYTE_D16 0x00000020
#define SQ_FLAT_LOAD_UBYTE_D16_HI 0x00000021
#define SQ_FLAT_LOAD_SBYTE_D16 0x00000022
#define SQ_FLAT_LOAD_SBYTE_D16_HI 0x00000023
#define SQ_FLAT_LOAD_SHORT_D16 0x00000024
#define SQ_FLAT_LOAD_SHORT_D16_HI 0x00000025
...
#define SQ_MSG_GET_DOORBELL 0x0000000a
...
#define SQ_V_SCREEN_PARTITION_4SE_B32 0x00000037
...
#define SQ_V_WRITELANE_REGWR_B32 0x00000050
...
#define SQ_V_PK_FMA_F16 0x0000000e
...
typedef enum PerfCounter_Vals {
  ...
  Spare_275 = 0x00000113,
  Spare_276 = 0x00000114,
  Spare_277 = 0x00000115,
  Spare_278 = 0x00000116,
  Spare_279 = 0x00000117,
  Spare_280 = 0x00000118,
  Spare_281 = 0x00000119,
  Spare_282 = 0x0000011a,
  Spare_283 = 0x0000011b,
  Spare_284 = 0x0000011c,
  ...
  DB_PERF_SEL_DFSM_cycles_above_watermark = 0x00000128,
...
typedef enum SU_PERFCNT_SEL {
  ...
  PERF_INDEX_RECEIVE_1_TO_7_VALID_DWORDS_THIS_CACHELINE = 0x000000e3,
  PERF_INDEX_RECEIVE_8_TO_15_VALID_DWORDS_THIS_CACHELINE = 0x000000e4,
  PERF_INDEX_RECEIVE_16_VALID_DWORDS_THIS_CACHELINE = 0x000000e5,
  PERF_POS_REQ_STALLED_BY_FULL_FETCH_TO_PRIMIC_P_FIFO = 0x000000e6,
  PERF_POS_REQ_STALLED_BY_FULL_FETCH_TO_PRIMIC_S_FIFO = 0x000000e7,
  PERF_POS_REQ_STALLED_BY_FULL_POSREQ_TO_POSRTN_V_FIFO = 0x000000e8,
  PERF_POS_REQ_STALLED_BY_FULL_POSREQ_TO_POSRTN_S_FIFO = 0x000000e9,
  PERF_POS_REQ_STALLED_BY_FULL_PA_TO_WD_DEALLOC_INDEX_FIFO = 0x000000ea,
  PERF_POS_REQ_STALLED_BY_NO_TOKENS = 0x000000eb,
  PERF_POS_REQ_STALLED_BY_NO_PRIM = 0x000000ec,
  PERF_POS_REQ_STALLED_BY_UTCL1 = 0x000000ed,
  PERF_POS_REQ_FETCH_TO_PRIMIC_P_FIFO_WRITE = 0x000000ee,
  PERF_POS_REQ_FETCH_TO_PRIMIC_P_FIFO_NO_WRITE = 0x000000ef,
  PERF_POS_REQ_QUALIFIED_BUSY = 0x000000f0,
  PERF_POS_REQ_QUALIFIED_STARVED = 0x000000f1,
  PERF_POS_RET_FULL_FETCH_TO_SXIF_FIFO = 0x000000f2,
  PERF_POS_RET_FULL_PA_TO_WD_DEALLOC_POSITION_FIFO = 0x000000f3,
  PERF_POS_RET_WAITING_ON_RETURNED_CACHELINE = 0x000000f4,
  PERF_POS_RET_FETCH_TO_SXIF_FIFO_WRITE = 0x000000f5,
  PERF_POS_RET_QUALIFIED_BUSY = 0x000000f6,
  PERF_POS_RET_QUALIFIED_STARVED = 0x000000f7,
  PERF_TC_LATENCY_BIN0 = 0x000000f8,
  PERF_TC_LATENCY_BIN1 = 0x000000f9,
  PERF_TC_LATENCY_BIN2 = 0x000000fa,
  PERF_TC_LATENCY_BIN3 = 0x000000fb,
  PERF_TC_LATENCY_BIN4 = 0x000000fc,
  PERF_TC_LATENCY_BIN5 = 0x000000fd,
  PERF_TC_LATENCY_BIN6 = 0x000000fe,
  PERF_TC_LATENCY_BIN7 = 0x000000ff,
  PERF_TC_STREAM0_DATA_AVAILABLE = 0x00000100,
  PERF_TC_STREAM1_DATA_AVAILABLE = 0x00000101,
  PERF_TC_STREAM2_DATA_AVAILABLE = 0x00000102,
  PERF_PAWD_DEALLOC_FIFO_IS_FULL = 0x00000103,
  PERF_PAWD_DEALLOC_WAITING_TO_BE_READ = 0x00000104,
  PERF_SHOOTDOWN_WAIT_ON_UTCL1 = 0x00000105,
  PERF_SHOOTDOWN_WAIT_ON_UTC_SIDEBAND = 0x00000106,
  PERF_SHOOTDOWN_WAIT_ON_UTC_INDEX = 0x00000107,
  PERF_SHOOTDOWN_WAIT_ON_UTC_POSITION = 0x00000108,
  PERF_SHOOTDOWN_WAIT_ALL_CLEAN = 0x00000109,
  PERF_SHOOTDOWN_WAIT_DEASSERT = 0x0000010a,
  PERF_UTCL1_TRANSLATION_MISS_CLIENT0 = 0x0000010b,
  PERF_UTCL1_TRANSLATION_MISS_CLIENT1 = 0x0000010c,
  PERF_UTCL1_TRANSLATION_MISS_CLIENT2 = 0x0000010d,
  PERF_UTCL1_PERMISSION_MISS_CLIENT0 = 0x0000010e,
  PERF_UTCL1_PERMISSION_MISS_CLIENT1 = 0x0000010f,
  PERF_UTCL1_PERMISSION_MISS_CLIENT2 = 0x00000110,
  PERF_UTCL1_TRANSLATION_HIT_CLIENT0 = 0x00000111,
  PERF_UTCL1_TRANSLATION_HIT_CLIENT1 = 0x00000112,
  PERF_UTCL1_TRANSLATION_HIT_CLIENT2 = 0x00000113,
  PERF_UTCL1_REQUEST_CLIENT0 = 0x00000114,
  PERF_UTCL1_REQUEST_CLIENT1 = 0x00000115,
  PERF_UTCL1_REQUEST_CLIENT2 = 0x00000116,
  PERF_UTCL1_STALL_MISSFIFO_FULL = 0x00000117,
  PERF_UTCL1_STALL_INFLIGHT_MAX = 0x00000118,
  PERF_UTCL1_STALL_LRU_INFLIGHT = 0x00000119,
  PERF_UTCL1_STALL_MULTI_MISS = 0x0000011a,
  PERF_UTCL1_LFIFO_FULL = 0x0000011b,
  PERF_UTCL1_STALL_LFIFO_NOT_RES_CLIENT0 = 0x0000011c,
  PERF_UTCL1_STALL_LFIFO_NOT_RES_CLIENT1 = 0x0000011d,
  PERF_UTCL1_STALL_LFIFO_NOT_RES_CLIENT2 = 0x0000011e,
  PERF_UTCL1_STALL_UTCL2_REQ_OUT_OF_CREDITS = 0x0000011f,
  PERF_UTCL1_UTCL2_REQ = 0x00000120,
  PERF_UTCL1_UTCL2_RET = 0x00000121,
  PERF_UTCL1_UTCL2_INFLIGHT = 0x00000122,
