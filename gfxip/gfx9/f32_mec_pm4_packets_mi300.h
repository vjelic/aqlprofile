...
#ifndef PM4_MEC_PRIME_ATCL2_DEFINED
#define PM4_MEC_PRIME_ATCL2_DEFINED

typedef struct PM4_MEC_PRIME_ATCL2
{
    union
    {
        PM4_MEC_TYPE_3_HEADER   header;            ///header
...
} PM4MEC_PRIME_ATCL2, *PPM4MEC_PRIME_ATCL2;
#endif
...
enum MEC_WRITE_DATA_coop_disable_enum {
     coop_disable__mec_write_data__master_and_slave_coop = 0,
     coop_disable__mec_write_data__master_only = 1 };
...
typedef struct PM4_MEC_WRITE_DATA
{
    ...
    union
    {
        struct
        {
            ...
            MEC_WRITE_DATA_coop_disable_enum coop_disable:1;
            uint32_t reserved5:4;
        } bitfields2;
        uint32_t ordinal2;
    };
