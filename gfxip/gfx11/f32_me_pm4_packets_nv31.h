...
enum ME_ATOMIC_MEM_cache_policy_enum {
     ...
     cache_policy__me_atomic_mem__noa = 2,
     cache_policy__me_atomic_mem__bypass = 3 };
...
enum ME_COPY_DATA_src_cache_policy_enum {
     ...
     src_cache_policy__me_copy_data__noa = 2,
     src_cache_policy__me_copy_data__bypass = 3 };
...
enum ME_COPY_DATA_dst_cache_policy_enum {
     ...
     dst_cache_policy__me_copy_data__noa = 2,
     dst_cache_policy__me_copy_data__bypass = 3 };
...
enum ME_DMA_DATA_src_cache_policy_enum {
     ...
     src_cache_policy__me_dma_data__noa = 2,
     src_cache_policy__me_dma_data__bypass = 3 };
...
enum ME_DMA_DATA_dst_cache_policy_enum {
     ...
     dst_cache_policy__me_dma_data__noa = 2,
     dst_cache_policy__me_dma_data__bypass = 3 };
...
enum ME_DMA_DATA_FILL_MULTI_dst_cache_policy_enum {
     ...
     dst_cache_policy__me_dma_data_fill_multi__noa = 2,
     dst_cache_policy__me_dma_data_fill_multi__bypass = 3 };
...
enum ME_EVENT_WRITE_event_index_enum {
     ...
     event_index__me_event_write__sample_streamoutstats = 8,
     event_index__me_event_write__sample_streamoutstats1 = 9,
     event_index__me_event_write__sample_streamoutstats2 = 10,
     event_index__me_event_write__sample_streamoutstats3 = 11 };
...
enum ME_GET_LOD_STATS_cache_policy_enum {
     ...
     cache_policy__me_get_lod_stats__noa = 2,
     cache_policy__me_get_lod_stats__bypass = 3 };
...
#ifndef PM4_ME_GFX_PIPE_LOCK_DEFINED
#define PM4_ME_GFX_PIPE_LOCK_DEFINED
...
} PM4ME_GFX_PIPE_LOCK, *PPM4ME_GFX_PIPE_LOCK;
#endif
...
enum ME_RELEASE_MEM_cache_policy_enum {
     ...
     cache_policy__me_release_mem__noa = 2,
     cache_policy__me_release_mem__bypass = 3 };
...
enum ME_WAIT_REG_MEM_cache_policy_enum {
     cache_policy__me_wait_reg_mem__lru = 0,
     cache_policy__me_wait_reg_mem__stream = 1,
     cache_policy__me_wait_reg_mem__noa = 2,
     cache_policy__me_wait_reg_mem__bypass = 3 };
...
enum ME_WAIT_REG_MEM64_cache_policy_enum {
     cache_policy__me_wait_reg_mem64__lru = 0,
     cache_policy__me_wait_reg_mem64__stream = 1,
     cache_policy__me_wait_reg_mem64__noa = 2,
     cache_policy__me_wait_reg_mem64__bypass = 3 };
...
enum ME_WRITE_DATA_cache_policy_enum {
     ...
     cache_policy__me_write_data__noa = 2,
     cache_policy__me_write_data__bypass = 3 };
