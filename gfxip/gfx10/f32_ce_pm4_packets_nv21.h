...
//--------------------CE_COND_INDIRECT_BUFFER_CONST--------------------

#ifndef PM4_CE_COND_INDIRECT_BUFFER_CONST_DEFINED
#define PM4_CE_COND_INDIRECT_BUFFER_CONST_DEFINED
...
enum CE_COND_INDIRECT_BUFFER_CONST_cache_policy1_enum {
     ...
     cache_policy1__ce_cond_indirect_buffer_const__noa = 2,
     cache_policy1__ce_cond_indirect_buffer_const__bypass = 3 };
...
enum CE_COND_INDIRECT_BUFFER_CONST_cache_policy2_enum {
     ...
     cache_policy2__ce_cond_indirect_buffer_const__noa = 2,
     cache_policy2__ce_cond_indirect_buffer_const__bypass = 3 };
...
enum CE_COPY_DATA_src_sel_enum {
     ...
     src_sel__ce_copy_data__tc_l2_obsolete = 1,
...
enum CE_COPY_DATA_dst_sel_enum {
     ...
     dst_sel__ce_copy_data__tc_l2_obsolete = 5 };

enum CE_COPY_DATA_src_cache_policy_enum {
     src_cache_policy__ce_copy_data__lru = 0,
     src_cache_policy__ce_copy_data__stream = 1,
     src_cache_policy__ce_copy_data__noa = 2,
     src_cache_policy__ce_copy_data__bypass = 3 };
...
enum CE_COPY_DATA_dst_cache_policy_enum {
     ...
     dst_cache_policy__ce_copy_data__noa = 2,
     dst_cache_policy__ce_copy_data__bypass = 3 };
...
enum CE_DUMP_CONST_RAM_cache_policy_enum {
     ...
     cache_policy__ce_dump_const_ram__noa = 2,
     cache_policy__ce_dump_const_ram__bypass = 3 };
...
enum CE_DUMP_CONST_RAM_OFFSET_cache_policy_enum {
     ...
     cache_policy__ce_dump_const_ram_offset__noa = 2,
     cache_policy__ce_dump_const_ram_offset__bypass = 3 };
...
enum CE_INDIRECT_BUFFER_CONST_cache_policy_enum {
     cache_policy__ce_indirect_buffer_const__lru = 0,
     cache_policy__ce_indirect_buffer_const__stream = 1,
     cache_policy__ce_indirect_buffer_const__noa = 2,
     cache_policy__ce_indirect_buffer_const__bypass = 3 };
...
enum CE_LOAD_CONST_RAM_cache_policy_enum {
     ...
     cache_policy__ce_load_const_ram__noa = 2,
     cache_policy__ce_load_const_ram__bypass = 3 };
...
enum CE_WRITE_DATA_cache_policy_enum {
     ...
     cache_policy__ce_write_data__noa = 2,
     cache_policy__ce_write_data__bypass = 3 };
