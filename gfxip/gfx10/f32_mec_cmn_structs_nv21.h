...
typedef struct STR_MEC_SDMA_128DW_MQD
{
    ...
    uint32_t sdmax_rlcx_rb_wptr_poll_cntl; // offset: 7  (0x7)
    ...
    uint32_t sdmax_rlcx_status; // offset: 19  (0x13)
    uint32_t sdmax_rlcx_doorbell_log; // offset: 20  (0x14)
    uint32_t sdmax_rlcx_watermark; // offset: 21  (0x15)
    uint32_t sdmax_rlcx_doorbell_offset; // offset: 22  (0x16)
    uint32_t sdmax_rlcx_csa_addr_lo; // offset: 23  (0x17)
    uint32_t sdmax_rlcx_csa_addr_hi; // offset: 24  (0x18)
    uint32_t sdmax_rlcx_ib_sub_remain; // offset: 25  (0x19)
    uint32_t sdmax_rlcx_preempt; // offset: 26  (0x1A)
    uint32_t sdmax_rlcx_dummy_reg; // offset: 27  (0x1B)
    uint32_t sdmax_rlcx_rb_wptr_poll_addr_hi; // offset: 28  (0x1C)
    uint32_t sdmax_rlcx_rb_wptr_poll_addr_lo; // offset: 29  (0x1D)
    uint32_t sdmax_rlcx_rb_aql_cntl; // offset: 30  (0x1E)
    uint32_t sdmax_rlcx_minor_ptr_update; // offset: 31  (0x1F)
    ...
    uint32_t sdmax_rlcx_midcmd_cntl; // offset: 41  (0x29)
...
typedef struct STR_MEC_COMPUTE_512DW_MQD
{
    ...
    uint32_t compute_relaunch; // offset: 44  (0x2C)
    uint32_t compute_wave_restore_addr_lo; // offset: 45  (0x2D)
    uint32_t compute_wave_restore_addr_hi; // offset: 46  (0x2E)
    uint32_t compute_wave_restore_control; // offset: 47  (0x2F)
    uint32_t reserved_48; // offset: 48  (0x30)
    uint32_t reserved_49; // offset: 49  (0x31)
    uint32_t reserved_50; // offset: 50  (0x32)
    uint32_t reserved_51; // offset: 51  (0x33)
