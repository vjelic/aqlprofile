...
if [[ ! "$gfxip" =~ ^(gfx9|gfx906|gfx908|gfx90a|gfx1030|gfx1031|gfx1032)$ ]]; then
    printf "Unknown GFXIP version \"$gfxip\", supported: gfx9/gfx906/gfx908/gfx90a/gfx1030|gfx1031|gfx1032\n"
    exit
fi
